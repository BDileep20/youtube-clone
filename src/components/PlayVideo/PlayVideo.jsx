...
const PlayVideo = () => {
  ...
  const fetchVideoData=async()=>{
    //Fetching Video Data
      ...
      await fetch(video_details_url).then(resp=>resp.json()).then(data=>setApidata(data.items[0]))
  ...
  return (
    <div className='play-video'>
      ...
      <div>
        ...
        <span>{channelData?value_converter(channelData.statistics.subscriberCount):null} Subscribers</span>
      </div>
      ...
      <div className="vid-description">
        ...
        <hr />
        <h4>{apiData?value_converter(apiData.statistics.commentCount):null}Comments</h4>
        {commentData.map((comment,ind)=>{
          return(
            ...
            <div>
                ...
                <p>{comment.snippet.topLevelComment.snippet.textDisplay}
                </p>
